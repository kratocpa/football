        ...
        private void resetPosition()
        {
            ...
            foreach (var item in players.Keys)
            {
                ...
                do
                {
                    if (p.isFirstTeam)
                    {
                        p.location.X = margins * pg.sizeX + r.Next((int)(pg.sizeX / 2 - pg.sizeX * margins));
                        p.location.Y = margins * pg.sizeY + r.Next((int)(pg.sizeY / 2 - pg.sizeY * margins));
                    }
                    else
                    {
                        p.location.X = r.Next((int)(pg.sizeX / 2 - pg.sizeX * margins)) + pg.sizeX / 2 + pg.sizeX * margins;
                        p.location.Y = r.Next((int)(pg.sizeY / 2 - pg.sizeY * margins)) + pg.sizeY / 2 - pg.sizeY * margins;
                    }
                } while (isInPenalty(p));
                p.velocity.X = 0;
                p.velocity.Y = 0;
